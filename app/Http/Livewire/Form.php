...
////////////////////////////// AAAAAAADDDDDDDDDDDDDDD ////////////////////
    ...
    public function essaie() {
        array_push($this->table, 1);
    }

    public function removet() {
        array_pop($this->table);
    }

    //***************************************

        public function includecursus() {
            include 'vuesform/formpart/cursuspar.blade.php';
        }
...
//////////////////////////////////////////////////////////////////////////////
    ...
    public function store(Request $request) {   
        ...
        //$filename2 = $request->personne->id() . '.' . $request->avatar->extention();
